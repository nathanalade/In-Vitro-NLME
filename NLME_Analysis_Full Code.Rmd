...
author:
  - Nathan Alade, M.S.^[University of Washington, Department of Pharmaceutics, correspondence; alade@uw.edu]
...
# **Weighting Non-Linear Mixed Effect Model (UM/EM)**
...
# **Population Michaelis-Menten Modeling (IM/PM)**
...
# **Weighting Non-Linear Mixed Effect Model (IM/PM)**
...
# **Final Model Evaluation (Qualitative Checks)**
...
# **Summary Tables for Covariate Model Estimates (w/ 95% CI)**
...
### PM Covariate Model (0% CV) CI Table 
...
### PM Covariate Model (5% CV) CI Table 
...
## CYP2D6 Intrinsic Clearance Prediction Residual (1/2)
...
## CYP2D6 Intrinsic Clearance Prediction Residual (2/2)
...
# **Model Evaluation (Bootstrap Analysis)**
...
## Bootstrapped Vmax Estimates (w/95% CI) Plot
...
## Bootstrapped Km Estimates (w/95% CI) Plot
